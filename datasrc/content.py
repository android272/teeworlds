...
container.sprites.Add(Sprite("tee_left_back_foot_outline", set_tee_feet, 0,0,1,1))
container.sprites.Add(Sprite("tee_left_back_foot", set_tee_feet, 1,0,1,1))
container.sprites.Add(Sprite("tee_left_back_foot_shadow", set_tee_feet, 0,1,1,1))
container.sprites.Add(Sprite("tee_left_back_foot_upper_outline", set_tee_feet, 1,1,1,1))

container.sprites.Add(Sprite("tee_left_front_foot_outline", set_tee_feet, 0,2,1,1))
container.sprites.Add(Sprite("tee_left_front_foot", set_tee_feet, 1,2,1,1))
container.sprites.Add(Sprite("tee_left_front_foot_shadow", set_tee_feet, 0,3,1,1))
container.sprites.Add(Sprite("tee_left_front_foot_upper_outline", set_tee_feet, 1,3,1,1))

container.sprites.Add(Sprite("tee_right_back_foot_outline", set_tee_feet, 2,0,1,1))
container.sprites.Add(Sprite("tee_right_back_foot", set_tee_feet, 3,0,1,1))
container.sprites.Add(Sprite("tee_right_back_foot_shadow", set_tee_feet, 2,1,1,1))
container.sprites.Add(Sprite("tee_right_back_foot_upper_outline", set_tee_feet, 3,1,1,1))

container.sprites.Add(Sprite("tee_right_front_foot_outline", set_tee_feet, 2,2,1,1))
container.sprites.Add(Sprite("tee_right_front_foot", set_tee_feet, 3,2,1,1))
container.sprites.Add(Sprite("tee_right_front_foot_shadow", set_tee_feet, 2,3,1,1))
container.sprites.Add(Sprite("tee_right_front_foot_upper_outline", set_tee_feet, 3,3,1,1))
