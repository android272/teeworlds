...
set_tee_feet = SpriteSet("tee_feet", image_null, 8, 8)
...
container.sprites.Add(Sprite("tee_left_back_foot_outline", set_tee_feet, 0,0,2,2))
container.sprites.Add(Sprite("tee_left_back_foot", set_tee_feet, 2,0,2,2))
container.sprites.Add(Sprite("tee_left_back_foot_shadow", set_tee_feet, 0,2,2,2))
container.sprites.Add(Sprite("tee_left_back_foot_upper_outline", set_tee_feet, 2,2,2,2))

container.sprites.Add(Sprite("tee_left_front_foot_outline", set_tee_feet, 0,4,2,2))
container.sprites.Add(Sprite("tee_left_front_foot", set_tee_feet, 2,4,2,2))
container.sprites.Add(Sprite("tee_left_front_foot_shadow", set_tee_feet, 0,6,2,2))
container.sprites.Add(Sprite("tee_left_front_foot_upper_outline", set_tee_feet, 2,6,2,2))

container.sprites.Add(Sprite("tee_right_back_foot_outline", set_tee_feet, 4,0,2,2))
container.sprites.Add(Sprite("tee_right_back_foot", set_tee_feet, 6,0,2,2))
container.sprites.Add(Sprite("tee_right_back_foot_shadow", set_tee_feet, 4,2,2,2))
container.sprites.Add(Sprite("tee_right_back_foot_upper_outline", set_tee_feet, 6,2,2,2))

container.sprites.Add(Sprite("tee_right_front_foot_outline", set_tee_feet, 4,4,2,2))
container.sprites.Add(Sprite("tee_right_front_foot", set_tee_feet, 6,4,2,2))
container.sprites.Add(Sprite("tee_right_front_foot_shadow", set_tee_feet, 4,6,2,2))
container.sprites.Add(Sprite("tee_right_front_foot_upper_outline", set_tee_feet, 6,6,2,2))
